...
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    "<div ng-switch=\"datepickerMode\" role=\"application\" class=\"datepicker\" ng-keydown=\"keydown($event)\">\n" +
...
angular.module("template/datepicker/day.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/day.html",
    ...
    "  <thead>\n" +
    "    <tr>\n" +
    "      <th class=\"prev\" ng-click=\"move(-1)\"><i class=\"fa fa-chevron-left\"></i></th>\n" +
    "      <th colspan=\"{{5 + showWeeks}}\" class=\"datepicker-switch text-muted\" ng-click=\"toggleMode()\">{{title}}</th>\n" +
    "      <th class=\"next\" ng-click=\"move(1)\"><i class=\"fa fa-chevron-right\"></i></th>\n" +
    "    </tr>\n" +
    "    <tr>\n" +
    "      <th ng-show=\"showWeeks\" class=\"cw\"></th>\n" +
    "      <th ng-repeat=\"label in labels track by $index\" class=\"dow\">{{label.abbr}}</th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
    "    <tr ng-repeat=\"row in rows track by $index\">\n" +
    "      <td ng-show=\"showWeeks\" class=\"cw\">{{ weekNumbers[$index] }}</td>\n" +
    "      <td ng-repeat=\"dt in row track by dt.date\" class=\"day\" ng-class=\"{old: dt.secondary, active: dt.selected, today: dt.current, disabled: dt.disabled, 'in-range': dt.inRange}\" ng-click=\"!dt.disabled && select(dt.date)\">\n" +
    "          {{dt.label}}\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
...
angular.module("template/datepicker/month.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/month.html",
    ...
    "    <tr>\n" +
    "      <th class=\"prev\" ng-click=\"move(-1)\"><i class=\"fa fa-chevron-left\"></i></th>\n" +
    "      <th colspan=\"5\" class=\"datepicker-switch\" ng-click=\"toggleMode()\">{{title}}</th>\n" +
    "      <th class=\"next\" ng-click=\"move(1)\"><i class=\"fa fa-chevron-right\"></i></th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
    "    <tr>\n" +
    "      <td colspan=\"7\">\n" +
    "        <span ng-repeat=\"dt in dates track by dt.date\" class=\"month\" ng-class=\"{disabled: dt.disabled, active: dt.selected, today: dt.current, 'in-range': dt.inRange}\" ng-click=\"!dt.disabled && select(dt.date)\">{{dt.label}}</span>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
...
angular.module("template/datepicker/year.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/year.html",
    ...
    "    <tr>\n" +
    "      <td colspan=\"7\">\n" +
    "        <span ng-repeat=\"dt in dates track by dt.date\" class=\"year\" ng-class=\"{old: dt.secondary, disabled: dt.disabled, active: dt.selected, today: dt.current, 'in-range': dt.inRange}\" ng-click=\"!dt.disabled && select(dt.date)\">{{dt.label}}</span>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
